...
function displayFlashMessage(message, className) {
  ...
  if(className !== "success"){
    flashMessageElement.style.backgroundColor = '#f44336';
  } else {
    flashMessageElement.style.backgroundColor = '#4CAF50';
  }
  ...
  if(isValidEmail(email)){
    ...
    $.ajax({
      ...
      data: {
        ...
        subject: subject,
        message: message,
        _token: $('input[name="_token"]').val(), // Ajoutez le jeton CSRF
      },
    ...
    displayFlashMessage("Votre message à bien été envoyé. Merci", "success");
    ...
    displayFlashMessage("erreur : cet email n'est pas valide", "error");
  }
